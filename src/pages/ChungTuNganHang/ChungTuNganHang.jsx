...
// function createData(cMaChungTu, cLoaiChungTu, cSoChungTu, dNgayChungTu, cHoTen, cMaKhachHang,
//   cTenKhachHang,cMaSoThue,cDienGiai,nThu_Chi
//   ) {
//   return {
//     cMaChungTu, cLoaiChungTu, cSoChungTu, dNgayChungTu, cHoTen, cMaKhachHang,
//   cTenKhachHang,cMaSoThue,cDienGiai,nThu_Chi
//   };
// }
...
//       try {
//         const response = await fetch('http://localhost:3000/chungtunganhang');
//         if (response) {
...
//   }, []);
//   data?.map(item=>{
//     rows.push(createData(item.cMaChungTu,item.cLoaiChungTu, item.cSoChungTu, item.dNgayChungTu, item.cHoTen, item.cMaKhachHang,
//       item.cTenKhachHang,item.cMaSoThue,item.cDienGiai,item.nThu_Chi))
//   })
